...
export default function NewArticle() {
  ...
  const [batchRows, setBatchRows] = useState<BatchRow[]>([
    { id: "1", topic: "", primaryKeyword: "", secondaryKeywords: "", targetAudience: "", wordCountTarget: "1500" },
  ]);
  ...
  const addRow = () => {
    ...
    setBatchRows((r) => [...r, { id: Date.now().toString(), topic: "", primaryKeyword: "", secondaryKeywords: "", targetAudience: "", wordCountTarget: "1500" }]);
  };
  ...
  const downloadTemplate = () => {
    const csv = "topic,primaryKeyword,secondaryKeywords,targetAudience,wordCountTarget\nExample Topic,example keyword,keyword2 keyword3,Small business owners,1500\n";
  ...
  return (
    <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-lg p-4 flex gap-3">
      ...
      <div className="text-xs text-blue-800 dark:text-blue-300 space-y-1">
        ...
        <p>The pipeline runs: Collate Inputs → Deep Research → Prompt Generation → Claude Draft → Humanization → AI-Signature Retries → Quality Checks → Final Formatting/Delivery.</p>
      </div>
    </div>
  );
}
